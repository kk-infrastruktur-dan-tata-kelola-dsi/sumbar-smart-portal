...
const allReports: Report[] = [
  { title: "APBD Tahun Anggaran 2025", size: "4.8 MB", date: "1 Nov 2024", year: "2025" },
  { title: "Rencana Kerja Anggaran (RKA) 2025", size: "5.2 MB", date: "15 Oct 2024", year: "2025" },
  { title: "Laporan Realisasi Anggaran Q1 2025", size: "3.1 MB", date: "15 Apr 2025", year: "2025" },
  { title: "Laporan Keuangan Pemprov 2024 (Audited)", size: "3.5 MB", date: "28 Jan 2025", year: "2024" },
  { title: "APBD Tahun Anggaran 2024", size: "4.3 MB", date: "7 Nov 2023", year: "2024" },
  { title: "Laporan Realisasi Anggaran 2024", size: "3.2 MB", date: "15 Jan 2025", year: "2024" },
  { title: "Neraca Daerah 2024", size: "2.8 MB", date: "15 Jan 2025", year: "2024" },
  { title: "Catatan Atas Laporan Keuangan 2024", size: "4.1 MB", date: "28 Jan 2025", year: "2024" },
  { title: "Laporan Keuangan Pemprov 2023 (Audited)", size: "3.4 MB", date: "15 Feb 2024", year: "2023" },
  { title: "APBD Tahun Anggaran 2023", size: "4.0 MB", date: "10 Nov 2022", year: "2023" },
  { title: "Laporan Realisasi Anggaran 2023", size: "3.0 MB", date: "20 Jan 2024", year: "2023" },
  { title: "Neraca Daerah 2023", size: "2.6 MB", date: "20 Jan 2024", year: "2023" },
  { title: "Laporan Keuangan Pemprov 2022 (Audited)", size: "3.3 MB", date: "10 Feb 2023", year: "2022" },
  { title: "APBD Tahun Anggaran 2022", size: "3.9 MB", date: "5 Nov 2021", year: "2022" },
  { title: "Laporan Realisasi Anggaran 2022", size: "2.9 MB", date: "15 Jan 2023", year: "2022" },
  { title: "Laporan Keuangan Pemprov 2021 (Audited)", size: "3.1 MB", date: "5 Feb 2022", year: "2021" },
  { title: "APBD Tahun Anggaran 2021", size: "3.7 MB", date: "1 Nov 2020", year: "2021" },
  { title: "Laporan Realisasi Anggaran 2021", size: "2.7 MB", date: "10 Jan 2022", year: "2021" },
];

const expendituresByYear: Record<string, Expenditure[]> = {
  "2025": [
    { category: "Belanja Pegawai", percentage: 45, label: "45% dari total belanja" },
    { category: "Barang & Jasa", percentage: 28, label: "28% dari total belanja" },
  ...
  "2024": [
    ...
    { category: "Barang & Jasa", percentage: 83, label: "83% dari total belanja" },
  ...
  "2023": [
    ...
    { category: "Barang & Jasa", percentage: 80, label: "80% dari total belanja" },
  ...
  "2022": [
    ...
    { category: "Barang & Jasa", percentage: 78, label: "78% dari total belanja" },
  ...
  "2021": [
    ...
    { category: "Barang & Jasa", percentage: 75, label: "75% dari total belanja" },
...
function SourceNote() {
  return (
    <div className="mt-4 flex items-start gap-3 rounded-civic-lg border border-civic-line bg-civic-stone/70 p-4 text-sm leading-6 text-civic-textMuted">
      <Database className="mt-0.5 h-4 w-4 shrink-0 text-semantic-primary" aria-hidden />
      <p>
      ...
      <PageHeader
        ...
        metadata={
          <>
            ...
            <StatusBadge variant="draft">Dokumen perlu sumber final</StatusBadge>
          </>
        }
        actions={
          ...
          {statisticCards.map((stat, index) => {
            ...
            return (
              ...
              >
                ...
                <p className="mt-3 text-sm font-semibold text-civic-text">{stat.label}</p>
        ...
        >
          <div className="rounded-civic-xl border border-civic-line bg-civic-cloud p-5 shadow-civic-xs">
            <div className="mb-4 flex items-center justify-between gap-4">
              ...
              <PieChart className="h-5 w-5 text-semantic-primary" aria-hidden />
            </div>
            <div className="h-80">
              {chartsReady ? (
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    tick={{ fontSize: 11, fill: chartColors.tick }}
                      ...
                      interval={0}
                    />
                  <YAxis tick={{ fontSize: 12, fill: chartColors.tick }} unit="%" />
                    <Tooltip
      ...
      >
        <div className="rounded-civic-xl border border-civic-line bg-civic-cloud p-5 shadow-civic-xs md:p-6">
          <div className="mb-5 flex flex-wrap items-center justify-between gap-4">
            ...
            <BarChart3 className="h-5 w-5 text-semantic-primary" aria-hidden />
          </div>
          <div className="h-96">
            {chartsReady ? (
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={trendData} margin={{ top: 16, right: 14, left: -10, bottom: 12 }}>
                  <CartesianGrid strokeDasharray="3 3" stroke={chartColors.grid} />
                  <XAxis
                    dataKey="year"
                  ...
                  <Line
                    ...
                    strokeWidth={3}
                    name="Realisasi"
                    dot={{ r: 4, fill: chartColors.realization, strokeWidth: 2 }}
                    activeDot={{ r: 6 }}
                  />
                </LineChart>
              </ResponsiveContainer>
